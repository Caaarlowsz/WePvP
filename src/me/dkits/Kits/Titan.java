...
public class Titan implements Listener
{
    ...
    public void onPlayerDamage(final EntityDamageEvent e) {
        if (e.getEntity() instanceof Player) {
            ...
            if (KitManager.titanmode.contains(p)) {
                e.setCancelled(true);
            }
        }
    }
    ...
    public void onPlayerHit(final EntityDamageByEntityEvent e) {
        ...
        if (e.getDamager() instanceof Player) {
            ...
            if (KitManager.titanmode.contains(d2)) {
                e.setCancelled(true);
                ...
                public void run() {
                    if (e.getPlayer().isSneaking()) {
                        ...
                        if (Titan.this.time.get(e.getPlayer()) == 10) {
                            ...
                            for (int i = 0; i < 36; ++i) {
                                if (e.getPlayer().getInventory().getItem(i) != null && e.getPlayer().getInventory().getItem(i).hasItemMeta() && e.getPlayer().getInventory().getItem(i).getItemMeta().hasDisplayName() && e.getPlayer().getInventory().getItem(i).getItemMeta().getDisplayName().startsWith("§c§lTitan Mode")) {
