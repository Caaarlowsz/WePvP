...
public class Fireman implements Listener, CommandExecutor
{
    ...
    public void damage(final EntityDamageEvent e) {
        if (e.getEntity() instanceof Player) {
            ...
            if (KitManager.fireman.contains(p.getName()) && (e.getCause() == EntityDamageEvent.DamageCause.LAVA || e.getCause() == EntityDamageEvent.DamageCause.FIRE || e.getCause() == EntityDamageEvent.DamageCause.FIRE_TICK)) {
                e.setCancelled(true);
            }
        }
    }
    ...
    public void Fogo(final EntityDamageByEntityEvent e) {
        if (e.getDamager() instanceof Player) {
            ...
            if (KitManager.fireman.contains(p.getName()) && p.getInventory().getItemInHand() != null && p.getInventory().getItemInHand().getType() == Material.WOOD_SWORD && e.getEntity() instanceof LivingEntity) {
