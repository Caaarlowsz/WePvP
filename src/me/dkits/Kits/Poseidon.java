...
public class Poseidon implements Listener, CommandExecutor
{
    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (label.equalsIgnoreCase("poseidon") && !KitManager.usandokit.contains(p.getName()) && p.hasPermission("kit.poseidon")) {
    ...
    public void onPlayerMove(final PlayerMoveEvent event) {
        ...
        if (KitManager.poseidon.contains(player.getName()) && (player.getLocation().getBlock().getType() == Material.WATER || player.getLocation().getBlock().getType() == Material.STATIONARY_WATER)) {
