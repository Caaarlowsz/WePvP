...
public class Magma implements Listener, CommandExecutor
{
    ...
    public void damage(final EntityDamageEvent e) {
        if (e.getEntity() instanceof Player) {
            ...
            if (KitManager.magma.contains(p.getName()) && (e.getCause() == EntityDamageEvent.DamageCause.LAVA || e.getCause() == EntityDamageEvent.DamageCause.FIRE || e.getCause() == EntityDamageEvent.DamageCause.FIRE_TICK)) {
                e.setCancelled(true);
            }
        }
    }
