...
public class Sonic implements Listener, CommandExecutor
{
    ...
    public void onClick(final InventoryClickEvent event) {
        ...
        if (this.cooldown.contains(p.getName()) && (event.getCurrentItem().getType() == Material.LEATHER_HELMET || event.getCurrentItem().getType() == Material.LEATHER_CHESTPLATE || event.getCurrentItem().getType() == Material.LEATHER_LEGGINGS || event.getCurrentItem().getType() == Material.LEATHER_BOOTS)) {
    ...
    public void clicou(final PlayerInteractEvent e) {
        ...
        if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) && i.getType() == Material.getMaterial(Main.plugin.getConfig().getString("ItemType")) && i.getItemMeta().getDisplayName().equalsIgnoreCase(Main.plugin.getConfig().getString("ItemName").replaceAll("&", "§"))) {
            e.setCancelled(true);
