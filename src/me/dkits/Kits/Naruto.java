...
public class Naruto implements Listener, CommandExecutor
{
    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (label.equalsIgnoreCase("naruto") && !KitManager.usandokit.contains(p.getName()) && p.hasPermission("kit.naruto")) {
    ...
    public void interact(final PlayerInteractEvent e) {
        ...
        if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) && KitManager.naruto.contains(p.getName()) && p.getItemInHand().getType() == Material.NETHER_STAR) {
