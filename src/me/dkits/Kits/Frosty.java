...
public class Frosty implements Listener, CommandExecutor
{
    ...
    public void onPlayerFrosty(final PlayerMoveEvent e) {
        ...
        if ((e.getTo().getBlock().getRelative(BlockFace.DOWN).getType() == Material.SNOW_BLOCK || e.getTo().getBlock().getRelative(BlockFace.DOWN).getType() == Material.ICE) && KitManager.frosty.contains(p.getName())) {
