...
public class Camel implements Listener, CommandExecutor
{
    ...
    public void onPlayerCamel(final PlayerMoveEvent e) {
        ...
        if ((e.getTo().getBlock().getRelative(BlockFace.DOWN).getType() == Material.SAND || e.getTo().getBlock().getRelative(BlockFace.DOWN).getType() == Material.SANDSTONE) && KitManager.camel.contains(p.getName())) {
