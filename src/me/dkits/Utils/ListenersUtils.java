...
public class ListenersUtils implements Listener
{
    ...
    public void onEntityDamage(final EntityDamageByEntityEvent e) {
        if (e.getDamager() instanceof Player && e.getEntity() instanceof Player) {
            ...
            if (!ListenersUtils.combatlog.contains(p.getName()) && !ListenersUtils.combatlog.contains(hitter.getName())) {
    ...
    public void naoUsarComando(final PlayerCommandPreprocessEvent e) {
        final Player p = e.getPlayer();
        if (ListenersUtils.combatlog.contains(p.getName()) && (e.getMessage().toLowerCase().startsWith("/spawn") || e.getMessage().toLowerCase().startsWith("/resetkit") || e.getMessage().toLowerCase().startsWith("/morrer") || e.getMessage().toLowerCase().startsWith("/suicide"))) {
            e.setCancelled(true);
        }
    }
    ...
    public void onDropItensIniciais(final PlayerDropItemEvent e) {
        if ((e.getItemDrop().getItemStack().getType() == Material.CHEST | e.getItemDrop().getItemStack().getType() == Material.THIN_GLASS | e.getItemDrop().getItemStack().getType() == Material.STAINED_GLASS_PANE) || e.getItemDrop().getItemStack().getType() == Material.DIAMOND || e.getItemDrop().getItemStack().getType() == Material.MAP) {
            e.setCancelled(true);
        }
    }
    ...
    public void onDropItensdeKit(final PlayerDropItemEvent e) {
        final Player p = e.getPlayer();
        if ((e.getItemDrop().getItemStack().getType() == Material.STONE_SWORD | e.getItemDrop().getItemStack().getType() == Material.WOOD_SWORD | e.getItemDrop().getItemStack().getType() == Material.getMaterial(351)) || e.getItemDrop().getItemStack().getType() == Material.GHAST_TEAR || e.getItemDrop().getItemStack().getType() == Material.BOW || e.getItemDrop().getItemStack().getType() == Material.BOOK || e.getItemDrop().getItemStack().getType() == Material.STICK || e.getItemDrop().getItemStack().getType() == Material.BLAZE_POWDER || e.getItemDrop().getItemStack().getType() == Material.REDSTONE_TORCH_ON || e.getItemDrop().getItemStack().getType() == Material.GOLD_BARDING) {
            e.setCancelled(true);
        }
        if ((e.getItemDrop().getItemStack().getType() == Material.GOLD_NUGGET | e.getItemDrop().getItemStack().getType() == Material.WOOL | e.getItemDrop().getItemStack().getType() == Material.getMaterial(351)) || e.getItemDrop().getItemStack().getType() == Material.NETHER_FENCE || e.getItemDrop().getItemStack().getType() == Material.IRON_BARDING || e.getItemDrop().getItemStack().getType() == Material.BONE || e.getItemDrop().getItemStack().getType() == Material.RED_ROSE || e.getItemDrop().getItemStack().getType() == Material.NETHER_STAR || e.getItemDrop().getItemStack().getType() == Material.ICE || e.getItemDrop().getItemStack().getType() == Material.FISHING_ROD) {
            e.setCancelled(true);
        }
        if ((e.getItemDrop().getItemStack().getType() == Material.SOUL_SAND | e.getItemDrop().getItemStack().getType() == Material.WOOD_HOE | e.getItemDrop().getItemStack().getType() == Material.getMaterial(351)) || e.getItemDrop().getItemStack().getType() == Material.IRON_SWORD || e.getItemDrop().getItemStack().getType() == Material.REDSTONE_BLOCK || e.getItemDrop().getItemStack().getType() == Material.LAPIS_BLOCK || e.getItemDrop().getItemStack().getType() == Material.FIREWORK || e.getItemDrop().getItemStack().getType() == Material.SADDLE || e.getItemDrop().getItemStack().getType() == Material.MILK_BUCKET || e.getItemDrop().getItemStack().getType() == Material.APPLE) {
            e.setCancelled(true);
        }
        if (e.getItemDrop().getItemStack().getType() == Material.SHEARS | e.getItemDrop().getItemStack().getType() == Material.ARROW | e.getItemDrop().getItemStack().getType() == Material.getMaterial(351)) {
            e.setCancelled(true);
        }
    }
    ...
    public void onPlayerChatRank(final AsyncPlayerChatEvent e) {
        final Player p = e.getPlayer();
        e.setFormat(String.valueOf(p.getDisplayName()) + ChatColor.RED + " » " + ChatColor.RESET + e.getMessage().replace("&", "§"));
    }
